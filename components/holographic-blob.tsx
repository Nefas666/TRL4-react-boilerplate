...
export default function HolographicBlob() {
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      <div className="absolute w-[280px] h-[280px] rounded-[45%_55%_60%_40%/50%_60%_40%_50%] holographic opacity-90 blur-sm animate-[morph_8s_ease-in-out_infinite,rotate-slow_20s_linear_infinite]" />

      {/* Secondary layer for depth */}
      <div className="absolute w-[260px] h-[260px] rounded-[55%_45%_40%_60%/60%_40%_60%_40%] holographic opacity-60 blur-md animate-[morph-reverse_10s_ease-in-out_infinite,rotate-slow_25s_linear_infinite_reverse]" />

      {/* Core glow */}
      <div className="absolute w-[240px] h-[240px] rounded-[40%_60%_55%_45%/55%_45%_55%_45%] holographic opacity-70 animate-[morph_12s_ease-in-out_infinite,pulse-slow_4s_ease-in-out_infinite]" />
