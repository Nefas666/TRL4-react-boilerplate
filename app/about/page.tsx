    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-5xl">
        <div className="mb-12 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">About From Soil to Systems</h1>
        ...
        <section className="mb-16">
          <Card className="border-0 card-shadow bg-card">
            ...
            <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                From Soil to Systems is an AI-powered platform that acts as a personal digital mentor. Users describe
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="border-0 card-shadow bg-card">
              ...
              <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  In "From Soil to Systems", Markesing leads the digital development and strategic coordination of the
                  platform.
                </p>
              </CardContent>
            </Card>
