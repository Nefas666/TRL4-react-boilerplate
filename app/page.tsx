            ...
            <section className="slide-content bg-soft-aqua py-20 relative rounded-t-3xl">
              <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto relative z-20">
                  ...
                  <div className="text-lg leading-relaxed bg-soft-aqua/80 backdrop-blur-sm rounded-3xl space-y-3 max-w-xl">
            ...
            <section className="slide-content bg-soft-lavender py-20 relative rounded-t-3xl">
              <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto relative z-20">
                  ...
                  <div className="space-y-6 text-lg leading-relaxed mb-12 bg-soft-lavender/80 backdrop-blur-sm p-8 rounded-3xl">
                    <p className="text-foreground/80">
