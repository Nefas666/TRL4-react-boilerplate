...
export default function HomePage() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] pointer-events-none z-10">
        <HolographicBlob />
      </div>

      <main className="flex-1 vertical-slides">
        <section className="slide-section bg-soft-yellow py-20 md:py-32 relative">
        ...
        <section className="slide-section bg-soft-aqua py-20 rounded-t-xl -mt-10">
        ...
        <section className="slide-section bg-soft-lavender py-20 rounded-t-xl -mt-10">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
        ...
        <section className="slide-section bg-soft-blue py-20 rounded-t-xl -mt-10">
          <div className="container mx-auto px-4">
        ...
        <section className="slide-section bg-soft-yellow py-10 rounded-t-xl -mt-10">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto text-center space-y-8 bg-secondary text-primary">
              ...
              <div className="max-w-md mx-auto">
                <div className="relative aspect-square w-full max-w-sm mx-auto">
                  {/* Blob is fixed and centered, so no need to repeat here */}
                </div>
              </div>
